...
<%@ page import="entity.DishDataReturn" %>
<%@ page import="entity.DishCategory" %>
...
<%
    DishDataReturn dishDataReturn = (DishDataReturn) request.getAttribute("dishDataReturn");
    ArrayList<DishCategory> dishCategory = (ArrayList<DishCategory>) request.getAttribute("categories");
                ...
                <div class="widget-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td scope="col" style="text-align: center">
                                <%
                                    for (DishCategory category : dishCategory) {
